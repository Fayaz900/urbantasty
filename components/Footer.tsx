    ...
    <footer className="bg-gray-900 text-white">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <p className="text-gray-400 mb-4">
              Premium quality stationary items for wholesale and retail. Your trusted partner for authentic products.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link href="#" className="text-gray-400 hover:text-primary transition-colors">Quality Assurance</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link href="#" className="text-gray-400 hover:text-primary transition-colors">Wholesale</Link></li>
              <li><Link href="#" className="text-gray-400 hover:text-primary transition-colors">Retail</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              ...
              <li className="flex items-start space-x-2">
                ...
                <span>4517 Washington Ave. Manchester, Kentucky 39465</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400">
          <p>Copyright © 2025 Urban Tasty. All rights reserved.</p>
        </div>
      </div>
    </footer>
  )
