        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <p className="text-lg md:text-xl text-gray-100 mb-8 leading-relaxed">
              Urban Tasty brings you authentic, premium quality stationary items. 
              From banana powder to coconut oil, we source the finest products for your business needs.
            </p>
          ...
          <div className="relative">
            <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-4 shadow-2xl overflow-hidden">
              <div className="aspect-square relative rounded-xl overflow-hidden">
                <Image
                  src="https://images.unsplash.com/photo-1556910103-2c027eb7e8cf?w=800&h=800&fit=crop&q=80"
